...
| T03 | `done` | Implement Phaser 2D office scene and gameplay viewport | [T03](./T03-phaser-office-scene.md) |
| T04 | `in_progress` | Implement tutorial, pause/resume, navigation guard, and results flow | [T04](./T04-pause-tutorial-results.md) |
