...
Leaderboard keys are `daily:YYYY-MM-DD` (UTC date) or `all-time`. Leaderboard reads are parameterized, partition-scoped, bounded to 100 rows, and return completed runs only.
